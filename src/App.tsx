...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#050505] text-[#FAFAFA] flex flex-col selection:bg-[#3B82F6]/20 selection:text-white">
      ...
      {/* Header Bar */}
      <header className="sticky top-0 z-40 bg-[#050505]/95 backdrop-blur-md border-b border-[#18181B] px-3 py-3 sm:px-4 sm:py-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center space-x-2">
            <span className="w-2 h-2 bg-[#3B82F6] shrink-0" />
            <span className="font-mono text-[9px] sm:text-[10px] md:text-[11px] tracking-[0.2em] sm:tracking-[0.25em] uppercase font-bold text-white leading-snug">MAYUR BABBE // SOLUTIONS ARCHITECT</span>
          </div>

          <div className="flex flex-wrap items-center gap-2 text-[8px] sm:text-[9px] md:text-[10px] uppercase font-mono tracking-[0.2em] sm:tracking-widest">
            <a href="#projects" className="rounded-full border border-[#18181B] bg-[#09090B]/80 px-2.5 py-1 text-[#A1A1AA] transition-colors hover:border-[#3B82F6]/40 hover:text-white">PROJECTS</a>
            <a href="#skills" className="rounded-full border border-[#18181B] bg-[#09090B]/80 px-2.5 py-1 text-[#A1A1AA] transition-colors hover:border-[#3B82F6]/40 hover:text-white">THE ARSENAL</a>
            <a href="#history" className="rounded-full border border-[#18181B] bg-[#09090B]/80 px-2.5 py-1 text-[#A1A1AA] transition-colors hover:border-[#3B82F6]/40 hover:text-white">MILESTONES</a>
          </div>
        </div>
      </header>

      {/* Hero Section */}
      <main className="flex-grow max-w-7xl w-full mx-auto px-3 sm:px-4 md:px-8 py-8 sm:py-10 md:py-12 space-y-10 sm:space-y-14 md:space-y-16">
        <section id="hero" className="py-2 sm:py-6 md:py-10 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
          <motion.div 
          ...
          >
            <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-[#09090B] border border-[#18181B] rounded-none text-[8px] sm:text-[9px] font-mono uppercase tracking-[0.15em] text-[#3B82F6] font-bold">
              <Award className="w-3.5 h-3.5 text-[#3B82F6]" />
              <span>ORACLE CERTIFIED GENERATIVE AI PROFESSIONAL</span>
            </div>

            <div className="space-y-3 sm:space-y-4">
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-white leading-none uppercase">
                Mayur Babbe
              </h1>
              <h2 className="text-base sm:text-lg md:text-xl font-medium tracking-tight text-[#A1A1AA]">
                Full-Stack MERN Architect & Generative AI Systems Developer
              </h2>
              
              {/* Personal Contact Metadata bar */}
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-x-4 gap-y-2 text-[9px] sm:text-[10px] font-mono text-[#71717A] uppercase tracking-wider pt-1">
            ...
            <p className="text-[#71717A] text-[11px] sm:text-xs md:text-sm leading-relaxed max-w-2xl font-mono">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2">
              <a 
                href="#projects"
                className="w-full sm:w-auto justify-center px-6 py-3 bg-[#3B82F6] hover:bg-[#2563eb] text-white text-[11px] font-bold uppercase tracking-wider rounded-xl transition-all flex items-center shadow-[0_20px_60px_rgba(59,130,246,0.25)]"
              >
              ...
              <a 
                href="#skills"
                className="w-full sm:w-auto justify-center px-6 py-3 bg-[#09090B] hover:bg-[#18181B] border border-[#27272A] text-white text-[11px] font-bold uppercase tracking-wider rounded-xl transition-all flex items-center"
              >
                Technical Arsenal
          ...
          <motion.div 
            ...
            className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4"
          >
            <MetricCard
              id="stat-grad"
              label="EDUCATION"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {PROJECTS.map((project, i) => (
              <motion.div 
                ...
                loading="lazy"
                id={`card-${project.id}`}
                className="group relative flex flex-col justify-between p-5 sm:p-6 bg-[#09090B] hover:bg-[#09090B]/80 border border-[#18181B] hover:border-[#3B82F6]/40 rounded-none transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="flex flex-col gap-3 pt-4 border-t border-[#18181B] sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex flex-wrap gap-1.5 max-w-full sm:max-w-[220px] md:max-w-[280px]">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto justify-center text-[10px] font-mono font-bold text-white hover:text-[#3B82F6] flex items-center space-x-1 border border-[#18181B] bg-[#050505] hover:bg-[#09090B] px-3 py-1.5 rounded-none transition-all cursor-pointer"
                  >
        ...
        >
          ...
          <div className="bg-[#09090B] border border-[#18181B] rounded-none p-5 sm:p-6 md:p-8">
          ...
          <div className="space-y-4">
            {WORK_HISTORY.map((work, idx) => (
              <motion.div 
                ...
                loading="lazy"
                className="p-5 sm:p-6 bg-[#09090B]/50 hover:bg-[#09090B] border border-[#18181B] rounded-none flex flex-col md:flex-row justify-between gap-4 transition-all duration-200"
              >
        ...
        <motion.section 
          ...
          className="py-8"
        >
          <div className="bg-[#09090B] border border-[#18181B] p-6 sm:p-8 rounded-none text-center space-y-6 relative overflow-hidden">
            ...
            <div className="relative z-10 pt-2 sm:pt-4 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <a
                ...
                id="btn-direct-email"
                className="w-full sm:w-auto px-6 py-3 bg-[#3B82F6] hover:bg-[#2563eb] font-bold text-white text-xs uppercase tracking-wider rounded-xl flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-[0_20px_60px_rgba(59,130,246,0.25)]"
              >
